...
macro(ie_parse_ci_build_number)
    ...
    if(DEFINED IEDevScripts_DIR AND DEFINED OpenVINO_MAIN_SOURCE_DIR AND NOT DEFINED custom_build)
        set(ie_version_hpp "${OpenVINO_MAIN_SOURCE_DIR}/runtime/core/include/ie_version.hpp")
    ...
    elseif(has_ci_version)
        message(WARNING "OpenVINO_MAIN_SOURCE_DIR is not defined. No way to compare versions")
    else()
